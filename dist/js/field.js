    ...
    methods: {
        ...
        fromAppTimezone: function fromAppTimezone(value) {
            ...
            if (this.field.timezoneAdjustment) {
                return moment.utc(value, 'HH:mm').clone().add(this.field.timezoneAdjustment, 'minutes').format('h:mm A');
            }
...
/* harmony default export */ __webpack_exports__["default"] = ({
    ...
    computed: {
        localizedValue: function localizedValue() {
            console.log('localized value', this.timezoneAdjustments);
            console.log(this.field.value);

            this.fromAppTimezone(this.value);
            console.log(this.userTimezone);
            console.log(this.fromAppTimezone(this.field.value));
            return this.timezoneAdjustments ? this.fromAppTimezone(this.field.value) : this.field.value;
        }
    }
});
...
var update = __webpack_require__(20)("05464087", content, false, {});
